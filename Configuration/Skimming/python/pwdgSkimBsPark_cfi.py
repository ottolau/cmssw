...
SkimBsPark = cms.EDFilter('LeptonSkimmingPhi',
     ...
     RunParameters = cms.PSet(
       #general
        ...
        #quadruple obj-track
        TrkTrkMinDR_Cut=cms.double(0.02),PtKleadTrack_Cut=cms.double(0.4),PtKsubleadTrack_Cut=cms.double(0.4),
	MaxMphi_Cut=cms.double(1.00),MinMphi_Cut=cms.double(1.04),
        Ksdxy_Cut=cms.double(0),MaxMB_Cut=cms.double(5.7),MinMB_Cut=cms.double(4.5),
        SLxy_Cut=cms.double(4.0),ProbeeKK_Cut=cms.double(0.001),CoseeKK_Cut=cms.double(0.9), 
