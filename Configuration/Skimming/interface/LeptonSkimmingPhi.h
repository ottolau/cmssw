...
class LeptonSkimmingPhi : public edm::stream::EDFilter<> {
   public:
      explicit LeptonSkimmingPhi(const edm::ParameterSet&);
      ~LeptonSkimmingPhi() override;
   ...
   private:
      ...
      double PtKleadTrack_Cut=0; double PtKsubleadTrack_Cut=0;
      double MaxMB_Cut=1000; double MinMB_Cut=0; double TrkTrkMinDR_Cut=10000;
      double MaxMphi_Cut=1000; double MinMphi_Cut=0;
      ...
      double EpairZvtx_Cut=10000000; double Ksdxy_Cut=1000; double ProbeeKK_Cut=0;
      double CoseeKK_Cut=0; double TrackMuDz_Cut=100000000; 
